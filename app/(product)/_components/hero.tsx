      ...
      <div className="w-5/6 lg:flex items-center justify-center gap-x-10">
        <div className="font-mono">
          <span className="flex items-center justify-center lg:items-start lg:justify-start gap-x-4">
            ...
            <p className="text-3xl lg:text-6xl font-bold text-white bg-[#6962AD] w-32 lg:w-72 text-center rounded-full border-b-8 border-b-[#3D3B40] border-r-8 border-r-[#3D3B40] border-t-2 border-t-[#3D3B40] border-l-2 border-l-[#3D3B40] -rotate-3">
              New Era
            </p>
          </span>
